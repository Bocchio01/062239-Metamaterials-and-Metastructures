...
E = ...
    (x_grid >= 0 & x_grid < L(1) | x_grid == L(6)) .* ST_cell(1).E{1}(t_grid) + ...
...
A = ...
    (x_grid >= 0 & x_grid < L(1) | x_grid == L(6)) .* ST_cell(1).A{1} + ...
...
J = ...
    (x_grid >= 0 & x_grid < L(1) | x_grid == L(6)) .* ST_cell(1).J{1} + ...
...
rho = ...
    (x_grid >= 0 & x_grid < L(1) | x_grid == L(6)) .* ST_cell(1).rho{1} + ...
